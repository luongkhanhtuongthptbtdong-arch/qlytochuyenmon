  ...
  dauVanBan(soVB, loaiVB){
    ...
    return `<table style="border:0;width:100%"><tr>
      ...
      <td style="border:0;width:50%;text-align:center">
        ...
        <div style="margin-top:8pt;font-style:italic;font-size:13pt">${U.esc(s.diaDanh||"")}, ngày ${new Date().getDate()} tháng ${new Date().getMonth()+1} năm ${new Date().getFullYear()}</div>
      </td>
    </tr></table>`;
  },
